  ...
  return (
    ...
    >
      <div className="contact-container">
        {/* Section Header */}
        <div className={`contact-header ${isVisible ? 'contact-header--visible' : 'contact-header--hidden'}`}>
        ...
        <div className={`contact-grid ${isVisible ? 'contact-grid--visible' : 'contact-grid--hidden'}`}>
          {/* Contact Info */}
          <div>
              ...
              {contactInfo.map((info, index) => (
                <div key={index} className="contact-info-item">
                  ...
                  <div>
                    ...
                    <p className="contact-info-item-content">{info.content}</p>
                  </div>
                </div>
              ))}
            </div>
