        ...
        <div className={`grid gap-12 lg:grid-cols-2 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
          ...
          <div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-[#0066cc]/10 rounded-full flex items-center justify-center text-[#0066cc] transition-all duration-300 hover:bg-[#0066cc] hover:text-white [&_svg]:w-5 [&_svg]:h-5 [&_svg]:fill-current">
          ...
          <div className="bg-gray-50 rounded-2xl p-8 lg:p-10">
            <form className="flex flex-col gap-6">
              ...
              <button type="submit" className="w-full bg-[#0066cc] text-white py-4 px-8 rounded-xl font-semibold border-none cursor-pointer transition-colors duration-300 hover:bg-[#0055aa] flex items-center justify-center gap-2 [&_svg]:w-5 [&_svg]:h-5">
                Send Message
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
